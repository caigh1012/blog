...
![1661867586539](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368880-58b67e.png)
...
![1661868116306](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368888-27612a.png)
...
🔔注意：TypeScript里的所有数字都是浮点数和Javascript一样，除了支持十进制和十六进制字面量，TypeScript还支持ECMAScript 2015中引入的二进制和八进制字面量
...
未在tsconfig.json进行strictNullChecks选项配置
...
tsconfig.json 配置了 strictNullChecks 选项配置
...
![1662208700431](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368896-d4c557.png)
...
![1662208937597](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368900-d80240.png)
...
![1662209212120](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368905-b31f46.png)
...
🔔注意：我们定义了一个数字枚举， Up使用初始化为 1。 其余的成员会从 1开始自动增长。 换句话说， Direction.Up的值为 1， Down为 2， Left为 3， Right为 4。
...
🔔注意： 现在， Up的值为 0， Down的值为 1等等。 当我们不在乎成员的值的时候，这种自增长的行为是很有用处的，但是要注意每个枚举成员的值都是不同的。
...
🔔注意：必须调用 super()，它会执行基类的构造函数。 而且，在构造函数里访问 this的属性之前，我们 一定要调用 super()。 这个是TypeScript强制执行的一条重要规则。
...
我们只讨论了类的实例成员，那些仅当类被实例化的时候才会被初始化的属性。 我们也可以创建类的静态成员，这些属性存在于类本身上面而不是类的实例上。用static进行定义，
...
🔔注意：抽象类不能被实例化，只能被继承。且子类必须构建抽象类的抽象成员

![1663484892006](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368914-b9a56d.png)
...
🔔注意：可选参数必须要在必需参数后面， 可选参数后面不允许再出现必需参数
...
![1662187029573](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368923-d0bf24.png)
...
![1662191526541](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368927-5b8751.png)
...
![1662191635639](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368931-9e436c.png)
...
![](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368935-715dbb.jpg)
...
![1663507351758](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368941-43e108.png)

#### 8.1.2、类型别名会报错

![1663507340555](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368946-914316.png)
...
![1663507489632](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368951-95baac.png)
...
![1663249578740](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368960-8f0808.png)

🔔注意： 类型推断发生在初始化变量和成员，设置默认参数值和决定函数返回值时。
...
🔔注意： 接口可以定义多次，类型别名不可以。与类型别名不同，接口可以定义多次，会被自动合并为单个接口。
...
![1662903370043](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368966-ab6988.png)
...
![1663409962316](https://gitee.com/caigh1012/assets/raw/main/learn/typescript/typescript-basic/2023-05-29-1685368972-c029ed.png)
