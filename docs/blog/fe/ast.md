...
![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/babel.png)
...
![1677487532483](https://gitee.com/caigh1012/assets/raw/main/blog/ast/1677487532483.png)
...
![1677489224740](https://gitee.com/caigh1012/assets/raw/main/blog/ast/1677489224740.png)

由此可以得到 AST 遍历的流程是深度优先，遍历过程如下：

![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/ast-traverse.jpg)
...
![1677488430721](https://gitee.com/caigh1012/assets/raw/main/blog/ast/1677488430721.png)
...
![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/ast_parser.png)

词法分析阶段

> 其中词法分析阶段扫描输入的源代码字符串，生成一系列的词法单元 (tokens)，这些词法单元包括数字，标点符号，运算符等。词法单元之间都是独立的，也即在该阶段我们并不关心每一行代码是通过什么方式组合在一起的。

![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/code-token.png)
...
![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/parsing.png)
...
![](https://gitee.com/caigh1012/assets/raw/main/blog/ast/transtion.png)

<span className="highlight">通俗解释：</span>我们已经弄清楚每一条句子的语法结构并知道如何写出语法正确的英文句子，通过这个基本结构我们可以把英文句子完美地转换成一个中文句子或是文言文（如果你会的话）。

V8具体生成的AST抽象语法树

![1677489661801](https://gitee.com/caigh1012/assets/raw/main/blog/ast/1677489661801.png)
